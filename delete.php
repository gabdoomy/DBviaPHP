...
echo "The records were deleted.<br><br>";
...
mysqli_query($con,"DELETE FROM users ".$nume.$prenume.$adresa.$email.$tel1.$tel2.$info);

$result = mysqli_query($con,"SELECT * FROM users");

echo "Remaining records:<br><br>";
$noresults=0;
...
if($noresults==0) echo "<b>No record deleted. Retry search.</b><br>";
else echo "</table>";
